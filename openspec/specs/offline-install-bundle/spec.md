...
- **THEN** it emits a `.tar.gz` containing `wheelhouse/` (core, plugins, serialwrap, and all third-party wheels), a pinned `requirements.txt`, the skill, and `testbed.yaml.example`, plus a sidecar `SHA256SUMS`
