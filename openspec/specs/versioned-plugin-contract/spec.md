# versioned-plugin-contract Specification

## Purpose
Define the TestPilot plugin SDK API contract version, require plugins to declare
the contract version they were built against, and fail plugin loading explicitly
when the host SDK is incompatible.
